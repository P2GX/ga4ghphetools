...
pub struct Phenopacket {
    ...
    pub subject: ::core::option::Option<core::Individual>,
    /// Phenotypic features relating to the subject of the phenopacket
    #[prost(message, repeated, tag = "3")]
    pub phenotypic_features: ::prost::alloc::vec::Vec<core::PhenotypicFeature>,
    /// Quantifiable measurements related to the individual
    #[prost(message, repeated, tag = "4")]
    pub measurements: ::prost::alloc::vec::Vec<core::Measurement>,
    /// Biosample(s) derived from the patient or a collection of biosamples in isolation
    #[prost(message, repeated, tag = "5")]
    pub biosamples: ::prost::alloc::vec::Vec<core::Biosample>,
    #[prost(message, repeated, tag = "6")]
    pub interpretations: ::prost::alloc::vec::Vec<core::Interpretation>,
    ...
    pub diseases: ::prost::alloc::vec::Vec<core::Disease>,
    #[prost(message, repeated, tag = "9")]
    pub medical_actions: ::prost::alloc::vec::Vec<core::MedicalAction>,
    /// Pointer to the relevant file(s) for the individual
    #[prost(message, repeated, tag = "10")]
    pub files: ::prost::alloc::vec::Vec<core::File>,
    /// Structured definitions of the resources and ontologies used within the phenopacket. REQUIRED
    #[prost(message, optional, tag = "11")]
    pub meta_data: ::core::option::Option<core::MetaData>,
}
...
pub struct Family {
    ...
    pub pedigree: ::core::option::Option<core::Pedigree>,
