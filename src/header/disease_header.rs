use crate::{dto::{template_dto::{DiseaseDto, IndividualBundleDto}, validation_errors::ValidationErrors}, header::duplet_item::DupletItem, template::disease_bundle::DiseaseBundle};
